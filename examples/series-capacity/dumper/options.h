...
#define OPTIONS_PACKAGE "dumper"
#endif

#ifndef OPTIONS_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define OPTIONS_PACKAGE_NAME "dumper"
#endif
...
struct gengetopt_args_info
{
  ...
  float capacity_arg;	/**< @brief maximal capacity.  */
  char * capacity_orig;	/**< @brief maximal capacity original value given at command line.  */
  const char *capacity_help; /**< @brief maximal capacity help description.  */
  char * output_arg;	/**< @brief output CSV.  */
  char * output_orig;	/**< @brief output CSV original value given at command line.  */
  const char *output_help; /**< @brief output CSV help description.  */
