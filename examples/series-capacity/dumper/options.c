...
const char *gengetopt_args_info_purpose = "Dump median for each double read from stdin";

const char *gengetopt_args_info_usage = "Usage: dumper [OPTIONS]... [FILES]...";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -c, --capacity=FLOAT  maximal capacity",
  "  -o, --output=STRING   output CSV",
...
{
  printf ("%s %s\n",
     (strlen(OPTIONS_PACKAGE_NAME) ? OPTIONS_PACKAGE_NAME : OPTIONS_PACKAGE),
     OPTIONS_VERSION);
...
void
options_init (struct gengetopt_args_info *args_info)
{
...
void
options_params_init(struct options_params *params)
{
  if (params)
    { 
      params->override = 0;
...
options_params_create(void)
{
  struct options_params *params = 
    (struct options_params *)malloc(sizeof(struct options_params));
  options_params_init(params);  
  return params;
}
...
int
options_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  int i = 0;
...
int
options_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  FILE *outfile;
  int i = 0;
  ...
  i = options_dump(outfile, args_info);
  fclose (outfile);
...
void
options_free (struct gengetopt_args_info *args_info)
{
  options_release (args_info);
}
...
int
options (int argc, char **argv, struct gengetopt_args_info *args_info)
{
  return options2 (argc, argv, args_info, 0, 1, 1);
}

int
options_ext (int argc, char **argv, struct gengetopt_args_info *args_info,
                   struct options_params *params)
{
  int result;
  result = options_internal (argc, argv, args_info, params, 0);
...
int
options2 (int argc, char **argv, struct gengetopt_args_info *args_info, int override, int initialize, int check_required)
{
  int result;
  struct options_params params;
 ...
 * @param check_ambiguity @see options_params.check_ambiguity
 * @param override @see options_params.override
                        ...
                        struct options_params *params, const char *additional_error)
{
  ...
  if (initialize)
    options_init (args_info);

  options_init (&local_args_info);
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVb:c:o:v", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'b':	/* number of histogram bins.  */
