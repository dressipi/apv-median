...
const char *gengetopt_args_info_purpose = "Dump histogram files for each double read from stdin";

const char *gengetopt_args_info_usage = "Usage: dump [OPTIONS]... [FILES]...";
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'c':	/* histogram capacity.  */
          ...
          break;
        case 'd':	/* location for JSON files.  */
